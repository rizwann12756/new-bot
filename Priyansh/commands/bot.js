...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "Rizu") || (event.body.toLowerCase() == "@Rizwan Ullah Qureshi") || (event.body.toLowerCase() == "rizwan") || (event.body.toLowerCase() == "prince")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞Rizwan☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Rizu🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ www.facebook.com/crypticrizu\n👋For Any Kind Of Help Contact On Telegram  Username 👉 @cryticrizu😇", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
     return api.sendMessage("He is Rizu. He Gives his name Rizwan Ullah Qureshi ", threadID);
   };

   if ((event.body.toLowerCase() == "shadi karoge") || (event.body.toLowerCase() == "mujhse shadi karoge?")) {
     return api.sendMessage("hanji, karunga lekin bacchy ka name kia rakhen ge ?", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "bsdk") || (event.body.toLowerCase() == "btc")) {
   ...
   if ((event.body.toLowerCase() == "bot k bacche") || (event.body.toLowerCase() == "bot ke bacche")) {
     return api.sendMessage("️Bacha mat bolna shiva naam he mera.", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "salam") || (event.body.toLowerCase() == "Assalam u Alaikum")) {
    return api.sendMessage("️وعليكم السلام ورحمۃ اللہ وبرکاتہ💚 😇", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Diba") || (event.body.toLowerCase() == "Diba Islam")) {
     return api.sendMessage("️Diba Busy hoti he. usy disturb mat kia kero☺😒  ", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Zukhruf") || (event.body.toLowerCase() == "😶")) {
     return api.sendMessage("️🙄🙄🙄", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
   ...
   if ((event.body.toLowerCase() == "kese ho sab") || (event.body.toLowerCase() == "kese ho") || (event.body.toLowerCase() == "kia haal he") || (event.body.toLowerCase() == "🤣") || (event.body.toLowerCase() == "😸") || (event.body.toLowerCase() == "😹")) {
     return api.sendMessage("me her waqt aap ke liey haazir hun😊  ", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "lob you") || (event.body.toLowerCase() == "i lob you")) {
   ...
   if ((event.body.toLowerCase() == "fuck") || (event.body.toLowerCase() == "Fuckk")) {
     return api.sendMessage("🏔🌊Chupp ganndy bachy•🫶", threadID);
   };

  if ((event.body.toLowerCase() == "hi rizwan") || (event.body.toLowerCase() == "kese ho rizu") || (event.body.toLowerCase() == "main amrita") || (event.body.toLowerCase() == "main priyansh") || (event.body.toLowerCase() == "main diya")) {
