...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "chutiya bot") || (event.body.toLowerCase() == "chutiye bot") || (event.body.toLowerCase() == "chumtiya bot") || (event.body.toLowerCase() == "chumtiye bot")) {
     return api.sendMessage("Hmm... Tu Chumtiya PhLe Ungli Kyun Ki Chomu 😾", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("Rizwan  ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
   ...
   if ((event.body.toLowerCase() == "rizwan") || (event.body.toLowerCase() == "@Rizwan Ullah Qureshi ") || (event.body.toLowerCase() == "rizu") || (event.body.toLowerCase() == "rizuu")) {
     return api.sendMessage("boss busy hoga. usy tang mat kero🙄  :))))", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "hi rizwan") || (event.body.toLowerCase() == "kese ho rizu") || (event.body.toLowerCase() == "riwan kese ho") || (event.body.toLowerCase() == "hi rizwan") || (event.body.toLowerCase() == "hello rizwan")) {
     return api.sendMessage("🕊️🍎...Aɭɛ Ɱɛɹɛ Ɓɑɓɣ Ƙɛʂɛ Ɦɵ ɑɑp😚 boss busy hongy. mujy btaao kia howa🍒", threadID);
   };
   mess = "{name}"
